...
namespace LibraryServices.EventBus.EventBusRabbitMQ
{
    public class EventBusRabbitMQ : IEventBus, IDisposable
    {
        ...
        {
            _logger.LogInformation("Subscribing to dynamic event {EventName} with {EventHandler}", eventName, GetGenericTypeName(typeof(TH)));
        ...
        public void Subscribe<T, TH>() where T : IntegrationEvent where TH : IIntegrationEventHandler<T>
        {
            ...
            _logger.LogInformation("Subscribing to event {EventName} with {EventHandler}", eventName, GetGenericTypeName(typeof(TH)));
