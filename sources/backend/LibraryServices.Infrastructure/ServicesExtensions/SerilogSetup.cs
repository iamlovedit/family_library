    ...
    public static class SerilogSetup
    {
        public static void AddSerilogSetup(this WebApplicationBuilder builder, IConfiguration configuration)
        {
            ...
            Log.Logger = new LoggerConfiguration()
                ...
                .Filter.ByExcluding("StartsWith(@m,'requestId: No RequestId, previousRequestId: No PreviousRequestId, message: 'Started polling')")
                .Filter.ByExcluding("StartsWith(@m,'requestId: No RequestId, previousRequestId: No PreviousRequestId, message: 'Finished polling')")
